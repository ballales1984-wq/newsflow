...
Write-Host "Aggiornamento notizie..." -ForegroundColor Cyan
Write-Host ""
...
# Aggiorna LOCALE (se backend e attivo)
...
try {
    ...
    Write-Host "Backend locale non attivo (normale se non lo stai usando)" -ForegroundColor Yellow
}
